...
async def set_commands(bot):
    if config_dict['SET_COMMANDS']:
        await bot.set_bot_commands(commands=[
            BotCommand(BotCommands.MirrorCommand[0], "Mulai mirror link dan file"),
            BotCommand(BotCommands.QbMirrorCommand[0], "Mirror file dengan qbittorrent"),
            BotCommand(BotCommands.YtdlCommand[0], "Mirror video YouTube"),
            BotCommand(BotCommands.LeechCommand[0], "Mulai leech link dan file"),
            BotCommand(BotCommands.QbLeechCommand[0], "Leech file dengan qbittorrent"),
            BotCommand(BotCommands.YtdlLeechCommand[0], "Leech video YouTube"),
            ...
            BotCommand(BotCommands.UserSetCommand[0], "Pengaturan pengguna"),
            BotCommand(BotCommands.HelpCommand, "Bantuan bot"),
            BotCommand(BotCommands.CloneCommand, "Clone file atau folder"),
            BotCommand(BotCommands.ExecCommand, "Eksekusi perintah"),
            BotCommand(BotCommands.AExecCommand, "Eksekusi perintah async"),
            BotCommand(BotCommands.SpeedCommand, "Cek kecepatan internet")
        ])
